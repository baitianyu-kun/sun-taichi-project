...
def main():
    ...
    parser.add_argument(
        'pose_lifter_config',default='./model/simplebaseline3d_h36m.py',
        help='Config file for the 2nd stage pose lifter model')
    parser.add_argument(
        'pose_lifter_checkpoint',default='./model/simple3Dbaseline_h36m-f0ad73a4_20210419.pth',
    ...
    parser.add_argument('--img-root', type=str, default='./data/h36m', help='Image root')
    parser.add_argument(
        '--json-file',
        type=str,
        default='./data/h36m/h36m_coco.json',
