...
def draw_weights(img,body_parts):
    opencvwrite2(img, (0, 0, 255), body_parts['left_shoulder'], body_parts['left_elbow'],
                 body_parts['left_wrist'])
    opencvwrite2(img, (0, 255, 0), body_parts['left_ass'], body_parts['left_knee'],
                 body_parts['left_jiaohuai'])
    opencvwrite2(img, (255, 0, 0), body_parts['left_ear'], body_parts['left_shoulder'],
                 body_parts['left_elbow'])
    opencvwrite2(img, (0, 0, 255), body_parts['right_shoulder'], body_parts['right_elbow'],
                 body_parts['right_wrist'])
    opencvwrite2(img, (0, 255, 0), body_parts['right_ass'], body_parts['right_knee'],
                 body_parts['right_jiaohuai'])
    opencvwrite2(img, (255, 0, 0), body_parts['right_ear'], body_parts['right_shoulder'],
